...
from foundationallm.cli.core.aaz._command_ctx import AAZCommandCtx
from foundationallm.cli.core.aaz import AAZArgumentsSchema
...
class TestAAZArgBaseFmt(unittest.TestCase):
    ...
    def test_str_fmt(self):
        from foundationallm.cli.core.aaz import AAZStrArg, AAZStrArgFormat
    ...
    def test_duration_fmt(self):
        from foundationallm.cli.core.aaz import AAZDurationArg, AAZDurationFormat
        schema = AAZArgumentsSchema()
    ...
    def test_date_fmt(self):
        from foundationallm.cli.core.aaz import AAZDateArg, AAZDateFormat
        schema = AAZArgumentsSchema()
    ...
    def test_time_fmt(self):
        from foundationallm.cli.core.aaz import AAZTimeArg, AAZTimeFormat
        schema = AAZArgumentsSchema()
    ...
    def test_datetime_fmt(self):
        from foundationallm.cli.core.aaz import AAZDateTimeArg, AAZDateTimeFormat
        schema = AAZArgumentsSchema()
    ...
    def test_uuid_fmt(self):
        from foundationallm.cli.core.aaz import AAZUuidArg, AAZUuidFormat
        schema = AAZArgumentsSchema()
    ...
    def test_int_fmt(self):
        from foundationallm.cli.core.aaz import AAZIntArg, AAZIntArgFormat
    ...
    def test_float_fmt(self):
        from foundationallm.cli.core.aaz import AAZFloatArg, AAZFloatArgFormat
    ...
    def test_bool_fmt(self):
        from foundationallm.cli.core.aaz import AAZBoolArg, AAZBoolArgFormat
    ...
    def test_object_fmt(self):
        from foundationallm.cli.core.aaz import AAZObjectArgFormat, AAZStrArgFormat, AAZBoolArgFormat, AAZIntArgFormat, \
            AAZDictArgFormat, AAZListArgFormat, AAZFloatArgFormat
        from foundationallm.cli.core.aaz import AAZObjectArg, AAZStrArg, AAZBoolArg, AAZIntArg, AAZDictArg, AAZListArg, \
            AAZFloatArg
    ...
    def test_dict_fmt(self):
        from foundationallm.cli.core.aaz import AAZObjectArgFormat, AAZDictArgFormat, AAZStrArgFormat, AAZIntArgFormat
        from foundationallm.cli.core.aaz import AAZObjectArg, AAZDictArg, AAZStrArg, AAZIntArg
    ...
    def test_freeform_dict_fmt(self):
        from foundationallm.cli.core.aaz import AAZFreeFormDictArgFormat
        from foundationallm.cli.core.aaz import AAZFreeFormDictArg
    ...
    def test_list_fmt(self):
        from foundationallm.cli.core.aaz import AAZObjectArgFormat, AAZListArgFormat, AAZStrArgFormat, AAZIntArgFormat
        from foundationallm.cli.core.aaz import AAZObjectArg, AAZListArg, AAZStrArg, AAZIntArg
    ...
    def test_aaz_file_arg_fmt(self):
        from foundationallm.cli.core.aaz import AAZArgumentsSchema, AAZFileArg, AAZFileArgTextFormat, \
    ...
    def test_aaz_pagination_token_fmt(self):
        from foundationallm.cli.core.aaz import AAZArgumentsSchema, AAZPaginationTokenArg, AAZPaginationTokenArgFormat
        schema = AAZArgumentsSchema()
