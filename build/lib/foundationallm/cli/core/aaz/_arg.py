...
class AAZBaseArg(AAZBaseType):
    ...
    def __init__(self, options=None, required=False, help=None, arg_group=None, is_preview=False, is_experimental=False,
        ...
        :param id_part: whether needs id part support in foundationallm.cli.core
...
class AAZResourceGroupNameArg(AAZStrArg):
    ...
    def to_cmd_arg(self, name, **kwargs):
        from foundationallm.cli.core.commands.parameters import get_resource_group_completion_list
...
class AAZResourceLocationArg(AAZStrArg):
    ...
    def to_cmd_arg(self, name, **kwargs):
        from foundationallm.cli.core.commands.parameters import get_location_completion_list
        from foundationallm.cli.core.local_context import LocalContextAttribute, LocalContextAction, ALL
        arg = super().to_cmd_arg(name, **kwargs)
