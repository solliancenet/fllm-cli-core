...
from foundationallm.cli.testsdk import ScenarioTest, LiveScenarioTest
from knack.util import CLIError
from foundationallm.cli.testsdk import live_only, MOCKED_USER_NAME
from foundationallm.cli.testsdk.constants import AUX_SUBSCRIPTION, AUX_TENANT

from foundationallm.cli.testsdk.scenario_tests.const import MOCKED_SUBSCRIPTION_ID, MOCKED_TENANT_ID
...
class TestClientFactory(unittest.TestCase):
    ...
    @mock.patch("foundationallm.cli.core.auth.identity.UserCredential", CredentialMock)
    @mock.patch('foundationallm.cli.core._profile.Profile.load_cached_subscriptions', return_value=mock_subscriptions)
