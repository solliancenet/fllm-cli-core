...
class TestAAZHttpOperation(unittest.TestCase):
    ...
    def test_aaz_http_operation_serialize_content(self):
        from foundationallm.cli.core.aaz._field_type import AAZObjectType, AAZListType, AAZDictType, AAZStrType, AAZIntType
        from foundationallm.cli.core.aaz._operation import AAZHttpOperation
...
class TestAAZGenericUpdateOperation(unittest.TestCase):
    ...
    def test_aaz_generic_update_operation(self):
        from foundationallm.cli.core.aaz._field_type import AAZObjectType, AAZListType, AAZDictType, AAZStrType, AAZIntType
        from foundationallm.cli.core.aaz._operation import AAZGenericInstanceUpdateOperation
    ...
    def test_aaz_generic_update_operation_with_flatten(self):
        from foundationallm.cli.core.aaz._field_type import AAZObjectType, AAZListType, AAZDictType, AAZStrType, AAZIntType
        from foundationallm.cli.core.aaz._operation import AAZGenericInstanceUpdateOperation
        from foundationallm.cli.core.aaz._base import has_value
