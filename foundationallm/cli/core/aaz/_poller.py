...
from foundationallm.core.exceptions import AzureError, HttpResponseError
from foundationallm.core.polling import NoPolling
from foundationallm.core.polling.base_polling import LROBasePolling
from foundationallm.core.tracing.common import with_current_context
from foundationallm.core.tracing.decorator import distributed_trace
# import requests in main thread to resolve import deadlock between threads in python
# reference https://github.com/psf/requests/issues/2925 and https://github.com/solliancenet/foundationallm/issues/26272
...
class AAZLROPoller:
    ...
    def result(self, timeout=None):
        ...
        :returns: The deserialized resource of the long running operation,
         if one is available.
        :raises ~foundationallm.core.exceptions.HttpResponseError: Server problem with the query.
        """
        self.wait(timeout)
