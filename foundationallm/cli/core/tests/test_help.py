...
from foundationallm.cli.core._help import CliCommandHelpFile

from foundationallm.cli.core.mock import DummyCli
from foundationallm.cli.core.commands import _load_command_loader
from foundationallm.cli.core.file_util import get_all_help
...
def mock_load_command_loader(loader, args, name, prefix):
    return _load_command_loader(loader, args, name, "foundationallm.cli.core.tests.")
...
def mock_inspect_getmembers(object, predicate=None):
    import foundationallm.cli.core.tests.test_help_loaders as possible_loaders

    if "foundationallm.cli.core._help_loaders" in repr(object) and "is_loader_cls" in repr(predicate):
...
def create_invoker_and_load_cmds_and_args(cli_ctx):
    ...
    from foundationallm.cli.core.commands.arm import register_global_subscription_argument, register_ids_argument
...
class TestHelpLoads(unittest.TestCase):
    ...
    @mock.patch('foundationallm.cli.core.commands._load_command_loader', side_effect=mock_load_command_loader)
...
class TestHelpSupportedProfiles(unittest.TestCase):
    def setUp(self):
        from foundationallm.cli.core.profiles._shared import AZURE_API_PROFILES
        self.test_cli = DummyCli()
    ...
    def test_example_inclusion_basic(self):
        from foundationallm.cli.core._help import CliHelpFile
