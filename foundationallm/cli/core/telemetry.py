...
from foundationallm.cli.core import decorators
from foundationallm.cli.telemetry import DEFAULT_INSTRUMENTATION_KEY
...
def flush():
    ...
    from foundationallm.cli.telemetry import save
...
def is_telemetry_enabled():
    from foundationallm.cli.core.cloud import cloud_forbid_telemetry
