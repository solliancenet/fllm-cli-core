...
from foundationallm.cli.core.aaz._prompt import AAZPromptInput, AAZPromptPasswordInput
...
class TestAAZPromptInput(unittest.TestCase):
    ...
    def test_pass_prompt_input(self, _):
        from foundationallm.cli.core.aaz._arg import AAZPasswordArg, AAZArgumentsSchema
        from foundationallm.cli.core.aaz._arg_action import AAZArgActionOperations
        from foundationallm.cli.core.aaz._arg_fmt import AAZStrArgFormat
        from foundationallm.cli.core.aaz import has_value
        schema = AAZArgumentsSchema()
        v = schema()
