...
class MSIAuthenticationWrapper(MSIAuthentication):
    # This method is exposed for Azure Core. Add *scopes, **kwargs to fit foundationallm.core requirement
    ...
    def set_token(self):
        import traceback
        from foundationallm.cli.core.azclierror import AzureConnectionError, AzureResponseError
        try:
            super().set_token()
