...
from foundationallm.cli.core.style import Style, Theme, format_styled_text, print_styled_text, _rgb_hex
...
\x1b[0m"""
    ...
    @mock.patch('foundationallm.cli.core.util.get_parent_proc_name', return_value='powershell.exe')
    @mock.patch('foundationallm.cli.core.style.is_modern_terminal', return_value=False)
    ...
    def test_highlight_command(self):
        from foundationallm.cli.core.style import Style, highlight_command, format_styled_text
    ...
    def test_format_styled_text_theme(self):
        from foundationallm.cli.core.style import Style, format_styled_text
        styled_text = [
            (Style.PRIMARY, "White: Primary text color\n"),
            (Style.SECONDARY, "Bright Black: Secondary text color\n"),
        ]
...
\x1b[0m"""
    ...
    @mock.patch("foundationallm.cli.core.style.format_styled_text")
