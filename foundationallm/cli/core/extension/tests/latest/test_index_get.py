...
from foundationallm.cli.core.extension._index import (get_index, get_index_extensions, DEFAULT_INDEX_URL,
...
class TestExtensionIndexGet(unittest.TestCase):
    ...
    def test_get_index_extensions(self):
        ...
        with mock.patch('foundationallm.cli.core.extension._index.logger.warning', autospec=True) as logger_mock:
            with mock.patch('requests.get', side_effect=mock_index_get_generator(DEFAULT_INDEX_URL, {})):
