...
class CommandRecommender():  # pylint: disable=too-few-public-methods
    ...
    def _set_aladdin_recommendations(self):  # pylint: disable=too-many-locals
        ...
        from foundationallm.cli.core import __version__ as version
    ...
    def provide_recommendations(self):
        ...
        from foundationallm.cli.core.style import Style, highlight_command
        from foundationallm.cli.core.parser import OVERVIEW_REFERENCE
    ...
    def _disable_aladdin_service(self):
        ...
        from foundationallm.cli.core.cloud import CLOUDS_FORBIDDING_ALADDIN_REQUEST
