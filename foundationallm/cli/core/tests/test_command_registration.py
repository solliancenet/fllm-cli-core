...
from foundationallm.cli.core import AzCommandsLoader, MainCommandsLoader
...
class TestCommandRegistration(unittest.TestCase):
    ...
    def _mock_load_command_loader(loader, args, name, prefix):
        ...
        class TestCommandsLoader(AzCommandsLoader):
            ...
            def load_command_table(self, args):
                ...
                self.__module__ = "foundationallm.cli.command_modules.hello"
                return self.command_table
        ...
        class Test2CommandsLoader(AzCommandsLoader):
            ...
            def load_command_table(self, args):
                ...
                self.__module__ = "foundationallm.cli.command_modules.extra"
                return self.command_table
        ...
        if prefix == 'foundationallm.cli.command_modules.':
    ...
    expected_command_index = {'hello': ['foundationallm.cli.command_modules.hello', 'azext_hello2', 'azext_hello1'],
                              'extra': ['foundationallm.cli.command_modules.extra']}
    ...
    @mock.patch('foundationallm.cli.core.commands._load_command_loader', _mock_load_command_loader)
    @mock.patch('foundationallm.cli.core.extension.get_extension_modname', _mock_get_extension_modname)
    @mock.patch('foundationallm.cli.core.extension.get_extensions', _mock_get_extensions)
    def test_register_command_from_extension(self):
        ...
        self.assertEqual(hello_mod_only_cmd.loader.__module__, 'foundationallm.cli.command_modules.hello')
    ...
    def test_command_index(self):
        ...
        from foundationallm.cli.core import CommandIndex, __version__
        ...
        _set_index({"network": ["foundationallm.cli.command_modules.network"]})
        loader.load_command_table(["hello", "mod-only"])
        _check_index()
        ...
        _set_index({"hello": ["foundationallm.cli.command_modules.extra"]})
        loader.load_command_table(["hello", "mod-only"])
        _check_index()
        ...
        outdated_command_index = {'hello': ['foundationallm.cli.command_modules.hello'],
                                  'extra': ['foundationallm.cli.command_modules.extra']}
        ...
        # Command index is explicitly invalidated by foundationallm.cli.core.extension.operations.add_extension
        ...
        outdated_command_index = {'hello': ['foundationallm.cli.command_modules.hello', 'azext_hello1'],
                                  'extra': ['foundationallm.cli.command_modules.extra']}
        _set_index(outdated_command_index)
    ...
    def test_command_index_always_loaded_extensions(self):
        ...
        with mock.patch.object(foundationallm.cli.core,'ALWAYS_LOADED_EXTENSIONS', ['azext_always_loaded']):
            loader.load_command_table(["hello", "mod-only"])
