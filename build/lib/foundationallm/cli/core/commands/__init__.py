...
from foundationallm.cli.core.commands.constants import (
...
from foundationallm.cli.core.util import (
    get_command_type_kwarg, read_file_content, get_arg_list, poller_classes)
from foundationallm.cli.core.local_context import LocalContextAction
...
class AzCliCommandInvoker(CommandInvoker):
    ...
    def execute(self, args):
        ...
        from foundationallm.cli.core.commands.events import (
    ...
    def _validate_arg_level(self, ns, **_):  # pylint: disable=no-self-use
        from foundationallm.cli.core.azclierror import AzCLIError
...
class LongRunningOperation:  # pylint: disable=too-few-public-methods
    ...
    def __call__(self, poller):  # pylint: disable=too-many-statements
        ...
        try:
            ...
            from foundationallm.cli.core.commands.arm import handle_long_running_operation_exception
            if self.progress_bar:
                self.progress_bar.stop()
...
def _load_module_command_loader(loader, args, mod):
    return _load_command_loader(loader, args, mod, 'foundationallm.cli.command_modules.')
...
def _is_paged(obj):
    ...
    if isinstance(obj, Iterable) \
        ...
        from foundationallm.core.paging import ItemPaged as AzureCorePaged
        from foundationallm.cli.core.aaz._paging import AAZPaged
...
class AzCommandGroup(CommandGroup):
    ...
    def __init__(self, command_loader, group_name, **kwargs):
        ...
        :type command_loader: foundationallm.cli.core.AzCommandsLoader
    ...
    def generic_update_command(self, name, getter_name='get', getter_type=None,
        ...
        from foundationallm.cli.core.commands.command_operation import GenericUpdateCommandOperation
        self._check_stale()
    ...
    def _wait_command(self, name, getter_name='get', getter_type=None, custom_command=False, **kwargs):
        from foundationallm.cli.core.commands.command_operation import WaitCommandOperation
        self._check_stale()
        merged_kwargs = self._flatten_kwargs(kwargs, get_command_type_kwarg(custom_command))
        self._apply_tags(merged_kwargs, kwargs, name)
    ...
    def _show_command(self, name, getter_name='get', getter_type=None, custom_command=False, **kwargs):
        from foundationallm.cli.core.commands.command_operation import ShowCommandOperation
        self._check_stale()
        merged_kwargs = self._flatten_kwargs(kwargs, get_command_type_kwarg(custom_command))
        self._apply_tags(merged_kwargs, kwargs, name)
