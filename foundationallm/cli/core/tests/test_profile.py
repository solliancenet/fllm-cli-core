...
from foundationallm.cli.core._profile import (Profile, SubscriptionFinder, _attach_token_tenant,
                                     _transform_subscription_for_multiapi)
from foundationallm.cli.core.auth.util import AccessToken
from foundationallm.cli.core.mock import DummyCli
...
# Used as the return_value of foundationallm.cli.core.auth.identity.Identity.get_user_credential
# If we directly patch foundationallm.cli.core.auth.msal_authentication.UserCredential with CredentialMock,
...
class TestProfile(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # Dummy result of foundationallm.cli.core._profile.SubscriptionFinder._find_using_specific_tenant
        ...
        # Dummy result of foundationallm.cli.core._profile.Profile._normalize_properties
    ...
    @mock.patch('foundationallm.cli.core._profile.SubscriptionFinder._create_subscription_client', autospec=True)
    @mock.patch('foundationallm.cli.core.auth.identity.Identity.get_user_credential', autospec=True)
    @mock.patch('foundationallm.cli.core.auth.identity.Identity.login_with_auth_code', autospec=True)
    @mock.patch('foundationallm.cli.core._profile.can_launch_browser', autospec=True, return_value=True)
    ...
    @mock.patch('foundationallm.cli.core._profile.SubscriptionFinder._create_subscription_client', autospec=True)
    @mock.patch('foundationallm.cli.core.auth.identity.Identity.get_user_credential', autospec=True)
    @mock.patch('foundationallm.cli.core.auth.identity.Identity.login_with_device_code', autospec=True)
    ...
    @mock.patch('foundationallm.cli.core._profile.SubscriptionFinder._create_subscription_client', autospec=True)
    @mock.patch('foundationallm.cli.core.auth.identity.Identity.get_user_credential', autospec=True)
    @mock.patch('foundationallm.cli.core.auth.identity.Identity.login_with_username_password', autospec=True)
    ...
    @mock.patch('foundationallm.cli.core._profile.SubscriptionFinder._create_subscription_client', autospec=True)
    @mock.patch('foundationallm.cli.core.auth.identity.Identity.get_service_principal_credential', autospec=True)
    @mock.patch('foundationallm.cli.core.auth.identity.Identity.login_with_service_principal', autospec=True)
    ...
    @mock.patch('foundationallm.cli.core._profile.SubscriptionFinder._create_subscription_client', autospec=True)
    @mock.patch('foundationallm.cli.core.auth.adal_authentication.MSIAuthenticationWrapper', autospec=True)
    ...
    @mock.patch('foundationallm.cli.core.profiles.get_api_version', autospec=True)
    ...
    @mock.patch('foundationallm.cli.core.auth.identity.Identity.get_user_credential', return_value=credential_mock)
    ...
    @mock.patch('foundationallm.cli.core.auth.adal_authentication.MSIAuthenticationWrapper', MSRestAzureAuthStub)
    ...
    @mock.patch('foundationallm.cli.core.auth.identity.Identity.get_user_credential')
    ...
    @mock.patch('foundationallm.cli.core.auth.identity.Identity.get_service_principal_credential')
    ...
    @mock.patch('foundationallm.cli.core._profile.in_cloud_console', autospec=True)
    @mock.patch('foundationallm.cli.core.auth.adal_authentication.MSIAuthenticationWrapper', autospec=True)
    ...
    @mock.patch('foundationallm.cli.core.auth.identity.Identity.logout_user')
    ...
    @mock.patch('foundationallm.cli.core.auth.identity.Identity.logout_all_users')
