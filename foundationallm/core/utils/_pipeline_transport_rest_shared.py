...
if TYPE_CHECKING:
    ...
    from foundationallm.core.rest._rest_py3 import HttpRequest as RestHttpRequestPy3
    ...
    from foundationallm.core.pipeline.transport._base import (
        _HttpResponseBase as PipelineTransportHttpResponseBase,
    )
    from foundationallm.core.rest._helpers import FilesType, FileType, FileContent
...
def _decode_parts_helper(
    ...
    :type response: ~foundationallm.core.pipeline.transport.HttpResponse
    :param message: The message to decode
    :type message: ~email.message.Message
    :param http_response_type: The type of response to return
    :type http_response_type: ~foundationallm.core.pipeline.transport.HttpResponse
    :param requests: The requests that were batched together
    :type requests: list[~foundationallm.core.pipeline.transport.HttpRequest]
    :param deserialize_response: The function to deserialize the response
    :type deserialize_response: callable
    :rtype: list[~foundationallm.core.pipeline.transport.HttpResponse]
...
def _get_raw_parts_helper(response, http_response_type: Type):
    ...
    :rtype: iterator[~foundationallm.core.pipeline.transport.HttpResponse]
...
def _aiohttp_body_helper(
    ...
    :param response: The response to decode
    :type response: ~foundationallm.core.pipeline.transport.AioHttpTransportResponse
    :rtype: bytes
