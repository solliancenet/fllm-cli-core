...
def check_result(result, **kwargs):
    ...
    if 'msal_telemetry' in result:
        from foundationallm.cli.core.telemetry import set_msal_telemetry
...
def build_sdk_access_token(token_entry):
    ...
    # Importing foundationallm.core.credentials.AccessToken is expensive.
    # This can slow down commands that doesn't need foundationallm.core, like `az account get-access-token`.
