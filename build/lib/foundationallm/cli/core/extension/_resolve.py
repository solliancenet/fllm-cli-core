...
from foundationallm.cli.core.extension import ext_compat_with_cli, WHEEL_INFO_RE, is_stable_from_metadata
from foundationallm.cli.core.extension._index import get_index_extensions
...
def resolve_from_index(extension_name, cur_version=None, index_url=None, target_version=None, cli_ctx=None,
    ...
    Raises:
        NoExtensionCandidatesError when an extension:
            ...
            * Has no versions that are compatible with the version of FLLM CLI
