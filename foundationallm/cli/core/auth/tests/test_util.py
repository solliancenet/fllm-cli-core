...
import unittest
from foundationallm.cli.core.auth.util import scopes_to_resource, resource_to_scopes, _normalize_scopes, _generate_login_command
...
class TestUtil(unittest.TestCase):
    ...
    def test_generate_login_command(self):
        ...
        assert _generate_login_command() == 'fllm login'

        # scopes
        actual = _generate_login_command(scopes=["https://management.core.windows.net//.default"])
        assert actual == 'fllm login --scope https://management.core.windows.net//.default'
