...
class TestAAZCommandCtx(unittest.TestCase):
    ...
    @mock.patch('foundationallm.cli.core.cloud.retrieve_arm_cloud_metadata', return_value=_METADATA)
    @mock.patch('foundationallm.cli.core.cloud.CLOUD_CONFIG_FILE', tempfile.mkstemp()[1])
    @mock.patch('foundationallm.cli.core.cloud.GLOBAL_CONFIG_DIR', tempfile.mkdtemp())
    ...
    def test_retrieve_value_in_arm_cloud_metadata(self, *args, **kwargs):
        from foundationallm.cli.core.aaz import AAZBaseClient
        from foundationallm.cli.core.cloud import get_active_cloud_name, refresh_known_clouds, _set_active_cloud, CloudSuffixes, CloudEndpoints
        from foundationallm.cli.core.aaz import AAZStrArg
        from foundationallm.cli.core.aaz import exceptions
