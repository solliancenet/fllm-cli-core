...
import warnings
try:
    from foundationallm.core.credentials import AccessToken as _AccessToken
except ImportError:
    _AccessToken = None
...
def get_cli_profile():
    ...
    *Disclaimer*: This method is not working for azure-cli-core>=2.21.0 (released in March 2021).
    ...
    :rtype: foundationallm.cli.core._profile.Profile
...
def get_azure_cli_credentials(resource=None, with_tenant=False):
    ...
    *Disclaimer*: This method is not working for azure-cli-core>=2.21.0 (released in March 2021).
    ...
    For compatible azure-cli-core version (< 2.20.0), credentials will be the "fllm login" command:
    ...
    try:
        import foundationallm.cli.core
        minor_version = int(foundationallm.cli.core.__version__.split(".")[1])
        if minor_version >= 21:
