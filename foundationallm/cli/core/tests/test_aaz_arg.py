...
from foundationallm.cli.core.aaz import exceptions as aazerror


class TestAAZArgShorthandSyntax(unittest.TestCase):

    def test_aaz_shorthand_syntax_simple_value(self):
        from foundationallm.cli.core.aaz._utils import AAZShortHandSyntaxParser
        from foundationallm.cli.core.aaz.exceptions import AAZInvalidShorthandSyntaxError
    ...
    def test_aaz_shorthand_syntax_dict_value(self):
        from foundationallm.cli.core.aaz._utils import AAZShortHandSyntaxParser, AAZBlankArgValue
        from foundationallm.cli.core.aaz.exceptions import AAZInvalidShorthandSyntaxError
        parser = AAZShortHandSyntaxParser()
        self.assertEqual(parser("{}"), {})
...
class TestAAZArg(unittest.TestCase):
    ...
    def test_aaz_compound_type_split_key(self):
        from foundationallm.cli.core.aaz._utils import AAZShortHandSyntaxParser, AAZInvalidShorthandSyntaxError
    ...
    def test_aaz_str_arg(self):
        from foundationallm.cli.core.aaz._arg import AAZStrArg, AAZArgumentsSchema
        from foundationallm.cli.core.aaz._arg_action import AAZArgActionOperations
        from foundationallm.cli.core.aaz import has_value
    ...
    def test_aaz_int_arg(self):
        from foundationallm.cli.core.aaz._arg import AAZIntArg, AAZArgumentsSchema
        from foundationallm.cli.core.aaz._arg_action import AAZArgActionOperations
        from foundationallm.cli.core.aaz import has_value
        schema = AAZArgumentsSchema()
        v = schema()
    ...
    def test_aaz_float_arg(self):
        from foundationallm.cli.core.aaz._arg import AAZFloatArg, AAZArgumentsSchema
        from foundationallm.cli.core.aaz._arg_action import AAZArgActionOperations
        from foundationallm.cli.core.aaz import has_value
        schema = AAZArgumentsSchema()
        v = schema()
    ...
    def test_aaz_bool_arg(self):
        from foundationallm.cli.core.aaz._arg import AAZBoolArg, AAZArgumentsSchema
        from foundationallm.cli.core.aaz._arg_action import AAZArgActionOperations
        from foundationallm.cli.core.aaz import has_value
        schema = AAZArgumentsSchema()
        v = schema()
    ...
    def test_aaz_list_arg(self):
        from foundationallm.cli.core.aaz._arg import AAZListArg, AAZStrArg, AAZArgumentsSchema, AAZObjectArg
        from foundationallm.cli.core.aaz._arg_action import AAZArgActionOperations, _ELEMENT_APPEND_KEY
        from foundationallm.cli.core.aaz import has_value
        schema = AAZArgumentsSchema()
        v = schema()
    ...
    def test_aaz_dict_arg(self):
        from foundationallm.cli.core.aaz._arg import AAZDictArg, AAZStrArg, AAZArgumentsSchema
        from foundationallm.cli.core.aaz._arg_action import AAZArgActionOperations
        from foundationallm.cli.core.aaz import has_value
        schema = AAZArgumentsSchema()
        v = schema()
    ...
    def test_aaz_freeform_dict_arg(self):
        from foundationallm.cli.core.aaz._arg import AAZFreeFormDictArg, AAZArgumentsSchema
        from foundationallm.cli.core.aaz._arg_action import AAZArgActionOperations
        from foundationallm.cli.core.aaz import has_value
        schema = AAZArgumentsSchema()
        v = schema()
    ...
    def test_aaz_object_arg(self):
        from foundationallm.cli.core.aaz._arg import AAZDictArg, AAZListArg, AAZObjectArg, AAZIntArg, AAZBoolArg, AAZFloatArg, \
    ...
    def test_aaz_has_value_for_buildin(self):
        from foundationallm.cli.core.aaz import has_value, AAZUndefined
    ...
    def test_aaz_registered_arg(self):
        from foundationallm.cli.core.aaz._arg import AAZStrArg, AAZObjectArg, AAZBoolArg, AAZArgumentsSchema
        from foundationallm.cli.core.aaz._arg_action import AAZArgActionOperations
        from foundationallm.cli.core.aaz import has_value
        from foundationallm.cli.core.aaz.exceptions import AAZUnregisteredArg
        schema = AAZArgumentsSchema()
        v = schema()
    ...
    def test_aaz_configured_default_arg(self):
        from foundationallm.cli.core.aaz._arg import AAZResourceGroupNameArg, AAZResourceLocationArg, AAZStrArg, AAZIntArg,\
            AAZArgumentsSchema
        schema = AAZArgumentsSchema()
        v = schema()
...
class TestAAZArgUtils(unittest.TestCase):
    ...
    def test_assign_aaz_list_arg(self):
        from foundationallm.cli.core.aaz.utils import assign_aaz_list_arg
        from foundationallm.cli.core.aaz._arg import AAZListArg, AAZStrArg, AAZObjectArg, AAZArgumentsSchema
        from foundationallm.cli.core.aaz._arg_action import AAZArgActionOperations
        from foundationallm.cli.core.aaz import has_value, AAZUndefined
        schema = AAZArgumentsSchema()
        v = schema()
    ...
    def test_assign_aaz_dict_arg(self):
        from foundationallm.cli.core.aaz.utils import assign_aaz_dict_arg
        from foundationallm.cli.core.aaz._arg import AAZDictArg, AAZStrArg, AAZObjectArg, AAZArgumentsSchema
        from foundationallm.cli.core.aaz._arg_action import AAZArgActionOperations
        from foundationallm.cli.core.aaz import has_value, AAZUndefined
        schema = AAZArgumentsSchema()
        v = schema()
