...
class TestUtils(unittest.TestCase):
    ...
    @mock.patch('foundationallm.cli.core.util._get_platform_info', autospec=True)
    ...
    @mock.patch('foundationallm.cli.core.__version__', '7.8.9')
    ...
    @mock.patch('foundationallm.cli.core._profile.Profile.get_raw_token', autospec=True)
...
class TestHandleException(unittest.TestCase):
    ...
    @mock.patch('foundationallm.cli.core.azclierror.logger.error', autospec=True)
