...
from foundationallm.cli.core._config import GLOBAL_CONFIG_DIR
from foundationallm.cli.core.util import urlretrieve
...
class CloudEndpoints:  # pylint: disable=too-few-public-methods,too-many-instance-attributes
    ...
    def __init__(self,  # pylint: disable=unused-argument
        ...
        self.management_client_id= management_client_id
...
FLLM_PUBLIC_CLOUD = Cloud(
    CloudNameEnum.FllmCloud,
    endpoints=CloudEndpoints(
        client_id='aa5cba99-e753-4d91-b2f8-85a6b650d022',
        instance_id='1e22cd2a-7b81-4160-b79f-f6443e3a6ac2',
        management_client_id='dc4b7d98-e404-4044-8040-4c7a5551e862',
        ...
        management_api_resource_id='api://FoundationaLLM-Management-Auth/Data.Manage',
...
HARD_CODED_CLOUD_LIST = [AZURE_PUBLIC_CLOUD, AZURE_CHINA_CLOUD, AZURE_US_GOV_CLOUD, AZURE_GERMAN_CLOUD, FLLM_PUBLIC_CLOUD]
...
def get_known_clouds(refresh=False):
    if 'ARM_CLOUD_METADATA_URL' in os.environ:
        from foundationallm.cli.core._session import CLOUD_ENDPOINTS
...
def _set_active_subscription(cli_ctx, cloud_name):
    from foundationallm.cli.core._profile import (Profile, _ENVIRONMENT_NAME, _SUBSCRIPTION_ID,
    ...
    if subscription_to_use:
        ...
        logger.warning("Use 'fllm login' to log in to this cloud.")
