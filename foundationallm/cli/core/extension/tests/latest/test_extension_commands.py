...
from foundationallm.cli.core.util import CLIError
from foundationallm.cli.core.extension import get_extension, build_extension_path
from foundationallm.cli.core.extension.operations import (add_extension_to_path, list_extensions, add_extension,
...
from foundationallm.cli.core.extension._resolve import NoExtensionCandidatesError
...
class TestExtensionCommands(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patchers = [mock.patch('foundationallm.cli.core.extension.EXTENSIONS_DIR', self.ext_dir),
                         mock.patch('foundationallm.cli.core.extension.EXTENSIONS_SYS_DIR', self.ext_sys_dir)]
    ...
    def test_add_extension_with_pip_proxy(self):
        ...
        with mock.patch('foundationallm.cli.core.extension.operations.resolve_from_index', return_value=(MY_EXT_SOURCE, computed_extension_sha256)), \
                mock.patch('foundationallm.cli.core.extension.operations.shutil'), \
                mock.patch('foundationallm.cli.core.extension.operations.check_output') as check_output:
    ...
    def test_add_extension_with_name_invalid_checksum(self):
        ...
        with mock.patch('foundationallm.cli.core.extension.operations.resolve_from_index', return_value=(MY_EXT_SOURCE, bad_sha256)):
    ...
    def test_add_extension_with_name_source_not_whl(self):
        ...
        with mock.patch('foundationallm.cli.core.extension.operations.resolve_from_index', return_value=('{}.notwhl'.format(extension_name), None)):
    ...
    def test_add_extension_with_name_but_it_already_exists(self):
        ...
        computed_extension_sha256 = _compute_file_hash(MY_EXT_SOURCE)
        with mock.patch('foundationallm.cli.core.extension.operations.resolve_from_index', return_value=(MY_EXT_SOURCE, computed_extension_sha256)):
            with mock.patch('foundationallm.cli.core.extension.operations.logger') as mock_logger:
    ...
    def test_update_extension(self):
        ...
        with mock.patch('foundationallm.cli.core.extension.operations.resolve_from_index', return_value=(newer_extension, computed_extension_sha256)):
    ...
    def test_update_extension_with_pip_proxy(self):
        ...
        with mock.patch('foundationallm.cli.core.extension.operations.resolve_from_index', return_value=(MY_EXT_SOURCE, computed_extension_sha256)), \
                mock.patch('foundationallm.cli.core.extension.operations.shutil'), \
                mock.patch('foundationallm.cli.core.extension.operations.is_valid_sha256sum', return_value=(True, computed_extension_sha256)), \
                mock.patch('foundationallm.cli.core.extension.operations.extension_exists', return_value=None), \
                mock.patch('foundationallm.cli.core.extension.operations.check_output') as check_output:
    ...
    def test_update_extension_no_updates(self):
        ...
        ext = show_extension(MY_EXT_NAME)
        self.assertEqual(ext[OUT_KEY_VERSION], '0.0.3+dev')
        with mock.patch('foundationallm.cli.core.extension.operations.resolve_from_index', side_effect=NoExtensionCandidatesError()), \
    ...
    def test_update_extension_exception_in_update_and_rolled_back(self):
        ...
        newer_extension = _get_test_data_file('myfirstcliextension-0.0.4+dev-py2.py3-none-any.whl')
        bad_sha256 = 'thishashisclearlywrong'
        with mock.patch('foundationallm.cli.core.extension.operations.resolve_from_index', return_value=(newer_extension, bad_sha256)):
            with self.assertRaises(CLIError) as err:
                update_extension(self.cmd, MY_EXT_NAME)
    ...
    def test_list_available_extensions_default(self):
        with mock.patch('foundationallm.cli.core.extension.operations.get_index_extensions', autospec=True) as c:
    ...
    def test_list_available_extensions_no_show_details(self):
        ...
        with mock.patch('foundationallm.cli.core.extension.operations.get_index_extensions', return_value=sample_index_extensions):
