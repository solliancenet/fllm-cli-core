...
from foundationallm.cli.core.profiles import (ResourceType, PROFILE_TYPE, CustomResourceType,
                                     get_api_version, supported_api_version, register_resource_type)
from foundationallm.cli.core.profiles._shared import APIVersionException, get_versioned_sdk_path
...
class TestAPIProfiles(unittest.TestCase):
    ...
    def test_get_api_version(self):
        ...
        with mock.patch('foundationallm.cli.core.profiles._shared.AZURE_API_PROFILES', test_profile):
    ...
    def test_register_resource_type_valid(self):
        ...
        with mock.patch('foundationallm.cli.core.profiles.API_PROFILES', test_profile):
    ...
    def test_get_versioned_sdk_path_semver(self):
        ...
        with mock.patch('foundationallm.cli.core.profiles._shared.AZURE_API_PROFILES', test_profile):
            self.assertEqual(
                ...
                "foundationallm.cli.command_modules.keyvault.vendored_sdks.azure_keyvault_t1.v7_0"
            )
