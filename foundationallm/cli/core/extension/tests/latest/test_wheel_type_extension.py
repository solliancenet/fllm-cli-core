...
from foundationallm.cli.core.extension import WheelExtension
try:
    from foundationallm.cli.core.extension.tests.latest import ExtensionTypeTestMixin, get_test_data_file
except ImportError:
...
class TestWheelTypeExtensionMetadata(ExtensionTypeTestMixin):
    ...
    def test_reading_wheel_type_0_30_0_extension_metadata(self):
        ...
        # assert FLLM CLI extended metadata
