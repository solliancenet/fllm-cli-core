...
from foundationallm.cli.core.commands import AzCliCommand
...
class TestParser(unittest.TestCase):
    ...
    def test_register_simple_commands(self):
        ...
        with mock.patch('foundationallm.cli.core.parser.AzCliCommandParser.error', new=VerifyError(self)):
    ...
    @mock.patch('foundationallm.cli.core.extension.get_extension_modname', _mock_extension_modname)
    ...
    def test_parser_error_spellchecker(self):
        ...
        def mock_log_error(logger_self, msg):
            # Only intercept 'cli.foundationallm.cli.core.azclierror' logger and ignore 'az_command_data_logger'
        ...
        with mock.patch.object(logging.Logger, 'error', mock_log_error), \
                mock.patch.object(foundationallm.cli.core.extension.operations, 'add_extension', mock_add_extension), \
                mock.patch.object(foundationallm.cli.core.extension.dynamic_install, '_get_extension_command_tree',
                                  mock_ext_cmd_tree_load), \
                mock.patch.object(foundationallm.cli.core.extension.dynamic_install, '_get_extension_use_dynamic_install_config',
                                  return_value='yes_without_prompt'), \
                mock.patch.object(foundationallm.cli.core.extension.dynamic_install,
