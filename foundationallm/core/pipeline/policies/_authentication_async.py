...
from foundationallm.core.credentials import AccessToken
from foundationallm.core.pipeline import PipelineRequest, PipelineResponse
from foundationallm.core.pipeline.policies import AsyncHTTPPolicy
from foundationallm.core.pipeline.policies._authentication import (
    _BearerTokenCredentialPolicyBase,
)
from foundationallm.core.pipeline.transport import AsyncHttpResponse as LegacyAsyncHttpResponse, HttpRequest as LegacyHttpRequest
from foundationallm.core.rest import AsyncHttpResponse, HttpRequest
from foundationallm.core.utils._utils import get_running_async_lock

from .._tools_async import await_result

if TYPE_CHECKING:
    from foundationallm.core.credentials_async import AsyncTokenCredential
...
class AsyncBearerTokenCredentialPolicy(AsyncHTTPPolicy[HTTPRequestType, AsyncHTTPResponseType]):
    ...
    :type credential: ~foundationallm.core.credentials.TokenCredential
    ...
    async def on_request(self, request: PipelineRequest[HTTPRequestType]) -> None:
        ...
        :raises: :class:`~foundationallm.core.exceptions.ServiceRequestError`
        """
