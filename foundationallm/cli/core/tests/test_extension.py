...
from foundationallm.cli.core.extension import (get_extensions, build_extension_path, extension_exists,
...
from foundationallm.cli.core.extension.operations import list_available_extensions, add_extension, show_extension, remove_extension, list_extensions, update_extension
...
class TestExtensions(TestExtensionsBase):
    ...
    def test_ext_compat_with_cli_no_v_constraint(self):
        ...
        azext_metadata = None
        with mock.patch('foundationallm.cli.core.__version__', expected_cli_version):
    ...
    def test_ext_compat_with_cli_require_ext_min_version(self):
        ...
        with mock.patch('foundationallm.cli.core.__version__', expected_cli_version), \
            mock.patch('foundationallm.cli.core.extension.EXTENSION_VERSION_REQUIREMENTS',
    ...
    def test_list_available_extensions_preview_details(self):
        ...
        with mock.patch('foundationallm.cli.core.extension.operations.get_index_extensions',
    ...
    def test_add_extension_without_preview(self):
        ...
        with mock.patch('foundationallm.cli.core.extension._resolve.get_index_extensions',
    ...
    def test_ext_dynamic_install_config_tty(self, _):
        from foundationallm.cli.core.extension.dynamic_install import _get_extension_use_dynamic_install_config
