...
class TestCommandRecommender(unittest.TestCase):
    ...
    def test_get_error_type(self):
        from foundationallm.cli.core.command_recommender import AladdinUserFaultType, get_error_type
    ...
    def test_get_parameter_mappings(self):
        ...
        from foundationallm.cli.core.command_recommender import get_parameter_mappings
