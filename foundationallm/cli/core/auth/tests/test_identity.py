...
from foundationallm.cli.core.auth.identity import (Identity, ServicePrincipalAuth, ServicePrincipalStore,
                                          _get_authority_url)
...
class TestIdentity(unittest.TestCase):
    ...
    @mock.patch("foundationallm.cli.core.auth.identity.ServicePrincipalStore.save_entry")
