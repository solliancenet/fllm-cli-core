...
from foundationallm.cli.core.profiles._shared import AZURE_API_PROFILES, ResourceType, CustomResourceType, PROFILE_TYPE, \
...
def get_api_version(cli_ctx, resource_type, as_sdk_profile=False):
    ...
    """
    from foundationallm.cli.core.profiles._shared import get_api_version as _sdk_get_api_version
...
def supported_api_version(cli_ctx, resource_type, min_api=None, max_api=None, operation_group=None):
    ...
    """
    from foundationallm.cli.core.profiles._shared import supported_api_version as _sdk_supported_api_version
...
def supported_resource_type(cli_ctx, resource_type):
    from foundationallm.cli.core.profiles._shared import supported_resource_type as _supported_resource_type
...
def get_sdk(cli_ctx, resource_type, *attr_args, **kwargs):
    ...
    """
    from foundationallm.cli.core.profiles._shared import get_versioned_sdk as _sdk_get_versioned_sdk
