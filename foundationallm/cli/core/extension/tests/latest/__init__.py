...
from foundationallm.cli.core.extension import EXT_METADATA_MAXCLICOREVERSION, EXT_METADATA_MINCLICOREVERSION
...
class IndexPatch:
    def __init__(self, data=None):
        self.patcher = mock.patch('foundationallm.cli.core.extension._resolve.get_index_extensions', return_value=data)
