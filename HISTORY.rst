...
2.28.0
++++++
* Conditional Access: Show `--scope` for `fllm login` message when failed to refresh the access token (#17738)
...
2.24.0
++++++
* Fix issue #16798: FLLM CLI output is corrupted! (#18065)
...
* Fix #15025: MSIAuthenticationWrapper not working with foundationallm.core (#15118)
...
2.0.79
++++++
* Fix #11586: `fllm login` is not recorded in server telemetry
...
* Fix #10760: `fllm login` fails if subscription name is None
...
.. _8399: https://github.com/solliancenet/foundationallm/issues/8399
...
* Fix issue where `--query` could not be used with `--ids`. [#5591](https://github.com/solliancenet/foundationallm/issues/5591)
