...
from foundationallm.cli.core.extension._resolve import (resolve_from_index, resolve_project_url_from_index,
...
class TestResolveFromIndex(unittest.TestCase):
    ...
    @mock.patch("foundationallm.cli.core.__version__", "2.15.0")
