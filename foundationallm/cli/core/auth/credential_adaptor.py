...
class CredentialAdaptor:
    def __init__(self, credential, resource=None, auxiliary_credentials=None):
        ...
        - Track 2: foundationallm.core.credentials.TokenCredential, which exposes get_token
    ...
    def _get_token(self, scopes=None, **kwargs):
        ...
        try:
            self._credential.client.default_headers['origin'] = 'fllm'
            ...
            from foundationallm.cli.core.util import SSLERROR_TEMPLATE
    ...
    def get_auxiliary_tokens(self, *scopes, **kwargs):
        # To test cross-tenant authentication, see https://github.com/solliancenet/foundationallm/issues/16691
        if self._auxiliary_credentials:
