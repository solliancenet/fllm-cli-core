...
from foundationallm.cli.core.commands.events import EVENT_INVOKER_PRE_CMD_TBL_TRUNCATE
...
class AzCliLogging(CLILogging):
    ...
    def configure(self, args):
        ...
        if self.log_level == CliLogLevel.DEBUG:
            # As foundationallm.core.pipeline.policies.http_logging_policy is a redacted version of
            # foundationallm.core.pipeline.policies._universal, disable foundationallm.core.pipeline.policies.http_logging_policy
            # when debug log is shown.
            logging.getLogger("foundationallm.core.pipeline.policies.http_logging_policy").setLevel(logging.CRITICAL)
